...
function validateSignature(req, res, next) {
  ...
  try {
    ...
    if (
      crypto.timingSafeEqual(bufferReceivedSignature, bufferGeneratedSignature)
    ) {
...
app.use(
  ...
  async (req, res) => {
    try {
      ...
      await axios.post(
        "http://informes.luvik.com.ar/shopify_cliente.php",
        data
      );
...
//   try {
//     console.log(
//       "Ejecutando limpieza de la base de datos... (ejecución inmediata)"
//     );
//     await Log.deleteMany({});
//     console.log("Limpieza de la base de datos completada.");
//   } catch (err) {
//     console.error(
//       "Error al limpiar la base de datos (ejecución inmediata):",
//       err
//     );
//   }
// })();
